 ...
 *        const { evenlySpaced, makeChocolate } = require('./ap-quiz-10');
 *        console.log(evenlySpaced(2, 4, 6)); // true
 *
 *     4. To run the tests, use Jest:
 *        `npm test` or `npx jest ap-quiz-10.test.js`
 *        (See ap-quiz-10.test.js for test setup instructions)
 *
 ...
 * @return {boolean} true if the numbers are evenly spaced, false otherwise
 */
 ...
 * </p>
 *
 * @param {number} small - Number of small 1-kg bars available
 * @param {number} big - Number of big 5-kg bars available
 * @param {number} goal - Target weight in kilos
 * @return {number} The number of small bars to use, or -1 if the goal cannot be met
 */
 ...
 * </p>
 *
 * @param {string} s - The input string containing digits and other characters
 * @return {number} The sum of all numbers found in the string
 */
 ...
 * @return {number} The length of the largest mirror section
 */
 ...
 * @return {string} The processed string with stars and adjacent chars removed
 */
function starOut(s) {
  // TODO: Implement your solution here
  return '';
 ...
 *
 * @param {string} s - The input string
 * @return {string} The modified string with standalone "is" replaced by "is not"
 */
 ...
 * @return {number} The number of clumps in the list
 */
 ...
 *
 * @param {number[]} nums - The input list of integers
 * @return {number[]} A list with evens first followed by odds
 */
 ...
 * @return {string[]} The FizzBuzz sequence as a list of strings
 */
 ...
 * </p>
 *
 * @param {number[]} nums - Unsorted list of integers
 * @return {number} Length of the longest run of consecutive integers
 */
 ...
 *
 * @param {number[]} nums - The input list of integers
 * @return {boolean} true if it is possible to split the array into two groups meeting the conditions, false otherwise
 */
 ...
 *
 * @param {number[]} nums - The input list of integers
 * @return {boolean} true if the array can be split according to the conditions, otherwise false
 */
 ...
 * @return {number} The result of base raised to the power of exp
 */
 ...
 *   <li>climbStairs(4) -> 5</li>
 *   <li>climbStairs(5) -> 8</li>
 * </ul>
 * </p>
 *
 * @param {number} n - The number of steps in the staircase (n >= 1)
 * @return {number} The number of distinct ways to climb the staircase
 */
 ...
 *     Quick Sort is a divide-and-conquer algorithm: select pivot, partition into
 *     less/equal/greater, recursively sort left and right, combine.
 * </p>
 * <p>
 * Examples:
 * <ul>
 ...
 * </p>
 *
 * @param {number[]} arr - The list of integers to sort
 * @return {number[]} A new sorted list containing all elements from arr
 */
 ...
 *     Merge Sort is a divide-and-conquer algorithm: divide into two halves,
 *     recursively sort each half, merge the two sorted halves.
 * </p>
 * <p>
 * Examples:
 * <ul>
 ...
 * </p>
 *
 * @param {number[]} left - A sorted list of integers
 * @param {number[]} right - A sorted list of integers
 * @return {number[]} A new sorted list containing all elements from both lists
 */
