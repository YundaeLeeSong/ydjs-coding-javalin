...
class APQuiz05 {
    companion object {
         ...
         * @return true if count of 1's is greater than count of 4's, false otherwise
         */
        @JvmStatic
         ...
         * @return true if count of "is" equals count of "not", false otherwise
         */
        @JvmStatic
        fun equalIsNot(s: String): Boolean {
            // TODO: Implement your solution here
            return false
        }
         ...
         * </p>
         *
         * @param nums The input list of integers containing matching numbers of 4's and 5's
         * @return A new list where each 4 is immediately followed by a 5
         */
        @JvmStatic
        fun fix45(nums: IntArray): IntArray {
            // TODO: Implement your solution here
            return intArrayOf()
        }
         ...
         * @return The resulting string of repeated words separated by `sep`
         */
        @JvmStatic
         ...
         * @param n Number of characters to start with (0 ≤ n ≤ len(s))
         ...
         * @return A list of strings "0" through str(n-1)
         */
        @JvmStatic
         ...
         */
        @JvmStatic
        fun array220(nums: IntArray, index: Int): Boolean {
            // TODO: Implement your solution here
            return false
        }
         ...
         *
         * @param s The input string
         * @return A new string where adjacent characters are separated by "*"
         */
        @JvmStatic
        fun allStar(s: String): String {
            // TODO: Implement your solution here
            return ""
        }
         ...
         *
         * @param s The input string
         * @return A new string where adjacent identical characters are separated by "*"
         */
        @JvmStatic
        fun pairStar(s: String): String {
            // TODO: Implement your solution here
            return ""
        }
         ...
         *
         * @param s The input string
         * @return A new string with all 'x' characters moved to the end
         */
        @JvmStatic
        fun endX(s: String): String {
            // TODO: Implement your solution here
            return ""
        }
    }
