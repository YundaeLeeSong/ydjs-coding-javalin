...
class APQuiz07 {
    companion object {
         ...
         * @return The sum of all digit characters found in the string
         */
        @JvmStatic
         ...
         * </p>
         *
         * @param outer A sorted list of integers (the superset)
         * @param inner A sorted list of integers to check for membership in `outer`
         * @return true if every element of `inner` appears in `outer`, false otherwise
         */
        @JvmStatic
        fun linearIn(outer: IntArray, inner: IntArray): Boolean {
            // TODO: Implement your solution here
            return false
        }
         ...
         * @return true if there's a 2-2 pair or a 4-4 pair (exclusively), false otherwise
         */
        @JvmStatic
         ...
         * @param nums2 Second list of integers, same length as nums1
         * @return The count of positions where the values differ by at most 2 but are not equal
         */
        @JvmStatic
         ...
         * @return true if there is a '77' pair or a '7_x_7' pattern, false otherwise
         */
        @JvmStatic
         ...
         *
         * @param nums The list of integers to check
         * @return true if a 1 is found with a 2 somewhere after it, false otherwise
         */
        @JvmStatic
         ...
         *
         * @param nums The list of integers to examine
         * @return true if there exists a run of three consecutive evens or three consecutive odds, false otherwise
         */
        @JvmStatic
         ...
         * @return true if the prefix of length `n` appears again in `s`, false otherwise
         */
        @JvmStatic
        fun prefixAgain(s: String, n: Int): Boolean {
            // TODO: Implement your solution here
            return false
        }
         ...
         *
         * @param s The input string
         * @return true if "xyz" appears in the middle by the above definition, false otherwise
         */
        @JvmStatic
        fun xyzMiddle(s: String): Boolean {
            // TODO: Implement your solution here
            return false
        }
         ...
         *   <li>closeFar(8, 6, 9) -> true    # c is far, b is far from c but close to a? actually b=6 is 2 away from a=8 -> far, c=9 is 1 away -> close</li>
         * </ul>
         * </p>
         *
         ...
         * @return true if exactly one of b or c is within 1 of a and the other differs by at least 2 from both, false otherwise
         */
        @JvmStatic
        fun closeFar(a: Int, b: Int, c: Int): Boolean {
            // TODO: Implement your solution here
            return false
        }
         ...
         *
         * @param s The input string
         * @return The count of valid "hi" occurrences
         */
        @JvmStatic
        fun countHi2(s: String): Int {
            // TODO: Implement your solution here
            return 0
        }
         ...
         *
         * @param s The input string
         * @return The substring enclosed within parentheses
         */
        @JvmStatic
        fun parenBit(s: String): String {
            // TODO: Implement your solution here
            return ""
        }
         ...
         *
         * @param s The input string
         * @return true if the string is a valid nesting of parentheses, false otherwise
         */
        @JvmStatic
        fun nestParen(s: String): Boolean {
            // TODO: Implement your solution here
            return false
        }
