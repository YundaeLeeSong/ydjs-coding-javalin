...
class APQuiz09 {
    companion object {
         ...
         */
        @JvmStatic
        fun groupNoAdj(start: Int, nums: IntArray, target: Int): Boolean {
            // TODO: Implement your solution here
            return false
        }
         ...
         */
        @JvmStatic
        fun groupSum5(start: Int, nums: IntArray, target: Int): Boolean {
            // TODO: Implement your solution here
            return false
        }
         ...
         */
        @JvmStatic
        fun groupSumClump(start: Int, nums: IntArray, target: Int): Boolean {
            // TODO: Implement your solution here
            return false
        }
