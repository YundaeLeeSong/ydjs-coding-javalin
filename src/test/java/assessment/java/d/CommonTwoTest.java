...
public class CommonTwoTest {
    ...
    public void testCommonTwo() {
        assertEquals(2, CommonTwo.commonTwo(
            new String[]{"a", "c", "x"}, new String[]{"b", "c", "d", "x"}));
        assertEquals(3, CommonTwo.commonTwo(
            new String[]{"a", "c", "x"}, 
        ...
        assertEquals(2, CommonTwo.commonTwo(
            new String[]{"b", "b", "b", "b", "c"}, 
            new String[]{"a", "b", "b", "b", "c"}));
        assertEquals(4, CommonTwo.commonTwo(
            new String[]{"a", "b", "c", "c", "d"}, 
            new String[]{"a", "b", "b", "c", "d", "d"}));
        assertEquals(1, CommonTwo.commonTwo(
            new String[]{"a", "a", "b", "b", "c"}, 
            new String[]{"b", "b", "b"}));
        assertEquals(1, CommonTwo.commonTwo(
            new String[]{"a", "a", "b", "b", "c"}, new String[]{"c", "c"}));
        assertEquals(1, CommonTwo.commonTwo(
            new String[]{"a", "a", "b", "b", "c"}, 
            new String[]{"b", "b", "b", "x"}));
        assertEquals(1, CommonTwo.commonTwo(
            new String[]{"a", "a", "b", "b", "c"}, new String[]{"b", "b"}));
        assertEquals(1, CommonTwo.commonTwo(
            new String[]{"a"}, new String[]{"a", "b"}));
        assertEquals(0, CommonTwo.commonTwo(
