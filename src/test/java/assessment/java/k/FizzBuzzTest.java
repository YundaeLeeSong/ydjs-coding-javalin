...
public class FizzBuzzTest {
    ...
    public void testFizzBuzz() {
        ...
        assertArrayEquals(
            new String[]{"1", "2", "Fizz", "4", "Buzz", "Fizz", "7", "8", 
                         "Fizz", "Buzz"}, 
        ...
        assertArrayEquals(new String[]{"FizzBuzz", "16"}, 
        ...
        assertArrayEquals(new String[]{"Fizz", "Buzz", "101"}, 
            FizzBuzz.fizzBuzz(99, 102));
        assertArrayEquals(
            new String[]{"14", "FizzBuzz", "16", "17", "Fizz", "19"}, 
