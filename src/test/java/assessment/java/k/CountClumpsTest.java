...
public class CountClumpsTest {
    ...
    public void testCountClumps() {
        ...
        assertEquals(4, CountClumps.countClumps(
            new int[]{2, 2, 1, 1, 1, 2, 1, 1, 2, 2}));
        assertEquals(4, CountClumps.countClumps(
            new int[]{0, 2, 2, 1, 1, 1, 2, 1, 1, 2, 2}));
        assertEquals(5, CountClumps.countClumps(
            new int[]{0, 0, 2, 2, 1, 1, 1, 2, 1, 1, 2, 2}));
        assertEquals(5, CountClumps.countClumps(
            new int[]{0, 0, 0, 2, 2, 1, 1, 1, 2, 1, 1, 2, 2}));
