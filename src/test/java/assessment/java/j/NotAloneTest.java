...
public class NotAloneTest {
    ...
    public void testNotAlone() {
        ...
        assertArrayEquals(new int[]{3, 3}, NotAlone.notAlone(new int[]{3, 3}, 3));
        assertArrayEquals(new int[]{1, 3, 3, 2}, NotAlone.notAlone(new int[]{1, 3, 1, 2}, 1));
        assertArrayEquals(new int[]{3}, NotAlone.notAlone(new int[]{3}, 3));
        assertArrayEquals(new int[]{}, NotAlone.notAlone(new int[]{}, 3));
        assertArrayEquals(new int[]{7, 7, 6}, NotAlone.notAlone(new int[]{7, 1, 6}, 1));
        assertArrayEquals(new int[]{1, 1, 1}, NotAlone.notAlone(new int[]{1, 1, 1}, 1));
        assertArrayEquals(new int[]{1, 1, 1, 2}, NotAlone.notAlone(new int[]{1, 1, 1, 2}, 1));
    }
}
