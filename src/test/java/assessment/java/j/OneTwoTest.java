...
public class OneTwoTest {
    ...
    public void testOneTwo() {
        ...
        assertEquals(longExpected, OneTwo.oneTwo(longInput.substring(0, longInput.length() - 1)));
        assertEquals(longExpected.substring(0, longExpected.length() - 3), OneTwo.oneTwo(longInput.substring(0, longInput.length() - 2)));
    }
}
