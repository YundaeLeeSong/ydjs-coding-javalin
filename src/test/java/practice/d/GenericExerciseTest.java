...
public class GenericExerciseTest {
    /**
     * If a GenericExercise is created that stores Strings, then it should be
     * able to set and retrieve String values.
     */
    @Test
     ...
     * wrapper class for ints), then it should be able to set and retrieve int
     * values.
     */
    @Test
