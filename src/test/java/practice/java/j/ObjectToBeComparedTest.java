...
public class ObjectToBeComparedTest {
    ...
    /**
     * If obj1 has a smaller value than that of obj2, obj1.compareTo(obj2)
     * should return a value less than 0.
     */
    @Test
    ...
    /**
     * If obj1 has a greater value than that of obj2, obj1.compareTo(obj2)
