...
public class QueueExerciseTest {
     ...
     * item removed from the queue. The size of the queue should also reflect
     * the removed item.
     */
    @Test
     ...
     * removed in the order "Jim", "Sally", "Kate". The size of the queue after
     * all values have been removed should also be 0.
     */
    @Test
