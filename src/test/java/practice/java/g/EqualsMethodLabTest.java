...
public class EqualsMethodLabTest {
    ...
    /**
     * Whatever the output that a toString contains, if an object is created
     * with the values 1, 1, true it should contain all of those values.
     */
    @Test
    ...
    /**
     * Whatever the output that a toString contains, if an object is created
     * with the values 1, 2, true it should contain all of those values.
     */
    @Test
    ...
    /**
     * Whatever the output that a toString contains, if an object is created
     * with the values 1, 1, false it should contain all of those values.
     */
    @Test
    ...
    /**
     * Whatever the output that a toString contains, if an object is created
     * with the values 1, 2, false it should contain all of those values.
     */
    @Test
