...
public class ExpressionsTest {
    static BooleanOperators e;
    
    @BeforeClass
    public static void setUp() {
        e = new BooleanOperators();
    }
    ...
    /**
     * If input1 is true and input2 is true, then returnAnd(input1, input2)
     * should return true.
     */
    @Test
    ...
    /**
     * If input1 is false and input2 is true, then returnAnd(input1, input2)
     * should return false.
     */
    @Test
    ...
    /**
     * If input1 is false and input2 is false, then returnAnd(input1, input2)
     * should return false.
     */
    @Test
    ...
    /**
     * If input1 is true and input2 is true, then returnOr(input1, input2)
     * should return true.
     */
    @Test
    ...
    /**
     * If input1 is true and input2 is false, then returnOr(input1, input2)
     * should return true.
     */
    @Test
    ...
    /**
     * If input1 is false and input2 is true, then returnOr(input1, input2)
     * should return true.
     */
    @Test
    ...
    /**
     * If input1 is false and input2 is false, then returnOr(input1, input2)
     * should return false.
     */
    @Test
