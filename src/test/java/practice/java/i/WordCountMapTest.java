...
public class WordCountMapTest {
    ...
    /**
     * In the String "giraffe zebra giraffe", giraffe occurs twice and zebra
     * occurs once.
     */
    @Test
    ...
    /**
     * In the String "apple pear melon apple pear apple", "apple" occurs 3
     * times, "pear" 2 times, "melon" 1 time.
     */
    @Test
