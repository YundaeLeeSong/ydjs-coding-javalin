...
public class IfStatementsTest {
     ...
     * 
     * This test verifies that, if exercise1() receives a boolean value of
     * `true`, it returns the value of the `x` parameter, which is 0.
     */
    @Test
     ...
     * 
     * This test verifies that, if exercise1() receives a boolean value of
     * `false`, it returns the value of the `y` parameter, which is 1.
     */
    @Test
     ...
     * 
     * This test verifies that, if exercise2() receives an integer value of 5,
     * it returns "Positive".
     */
    @Test
     ...
     * Tests the exercise2() method of the IfStatements class.
     * 
     * This test verifies that, if exercise2() receives an integer value of -10,
     * it returns "Negative".
     */
    @Test
     ...
     * Tests the exercise2() method of the IfStatements class.
     * 
     * This test verifies that, if exercise2() receives an integer value of 0,
     * it returns "Zero".
     */
    @Test
     ...
     * 
     * This test verifies that, if exercise3() receives an integer value of
     * 2025, which is not divisible by 4, it returns "No".
     */
    @Test
     ...
     * 
     * This test verifies that, if exercise3() receives an integer value of
     * 2000, because it is divisible by both 100 and 400, it returns "Yes".
     */
    @Test
     ...
     * 
     * This test verifies that, if exercise3() receives an integer value of
     * 1900, because it is divisible by 100 but NOT 400, it returns "Not quite".
     */
    @Test
     ...
     * 
     * This test verifies that, if exercise3() receives an integer value of
     * 2024, because it is divisible by 4, it returns "Yes".
     */
    @Test
