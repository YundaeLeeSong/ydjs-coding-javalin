...
public class ContainsDuplicatesTest {
    ...
    /**
     * The array {1, 2, 3, 4, 5} does not contain any duplicates, so
     * containsDuplicate should return false.
     */
    @Test
    ...
    /**
     * The array {1, 2, 2, 3, 4, 5} contains duplicates, so containsDuplicate
     * should return true.
     */
    @Test
    ...
    /**
     * The array {1, 1, 1, 1, 1} contains duplicates, so containsDuplicate
     * should return true.
     */
    @Test
    ...
    /**
     * The array {5,8,3,4,5,0} contains duplicates, so containsDuplicate should
     * return true.
     */
    @Test
