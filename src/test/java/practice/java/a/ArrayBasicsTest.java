...
public class ArrayBasicsTest {
    ...
    /**
     * If we have an array predefined as {8,4,7,3,8,5}, attempting to get the
     * item at index 2 should return 7.
     */
    @Test
    ...
    /**
     * If we have an array predefined as {5,3,9,1,0}, attempting to get the
     * item at index 0 should return 5.
     */
    @Test
    ...
    /**
     * If we have an array predefined as {6,4,8}, attempting to get the item
     * at index 2 should return 8.
     */
    @Test
    ...
    /**
     * If we have an array predefined as {9,3,7,3,6}, attempting to change the
     * value at index 2 to 5 should result in an array {9,3,5,3,6}, where the
    ...
    /**
     * If we have an array predefined as {9,3,4}, attempting to change the
     * value at index 0 to 2 should result in an array {2,3,4}, where the value
     * at index 0 is 2.
     */
    @Test
    ...
    public void returnNewArraySizeNTest1() {
        ...
        if (output == null) {
            Assert.fail("array has not been created.");
        } else {
