...
public class StackImplementationExerciseTest {
    ...
    /**
     * A stack with 3 items which then has an item removed should have a size of
     * 2. The removed item should be the most recently added item.
     */
    @Test
    ...
    /**
     * A stack with 3 items which then has 2 items removed should have a size of
     * 1. The most recently added item should be removed first.
     */
    @Test
