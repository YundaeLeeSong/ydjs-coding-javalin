...
public class ListExerciseTest {
    ...
    /**
     * When an item is added to an empty list, the item can be retrieved by
    ...
    /**
     * When two items are added to an empty list, the second item can be
     * retrieved by getting the element at index 1.
     */
    @Test
    ...
    /**
     * When the only item in a list is removed, that list should be empty and
     ...
     * contain the removed item, but should still contain the other item and
     * have a size of 1.
     */
    @Test
    ...
    /**
     * When we update a value in list, it should contain the new value and
