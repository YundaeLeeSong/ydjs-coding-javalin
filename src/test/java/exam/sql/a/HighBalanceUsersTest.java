...
public class HighBalanceUsersTest {
    ...
    public void setup() throws Exception {
        ...
        for (String setupSql : FileManager.parseSqlFile("exam/sql/a/high_balance_users_reset.sql")) {
    ...
    public void testHighBalanceUsers() throws Exception {
        Statement stmt = conn.createStatement();
        for (String setupSql : FileManager.parseSqlFile("exam/sql/a/high_balance_users_setup.sql")) {
            stmt.execute(setupSql);
        }

        String sql = FileManager.readFile(HighBalanceUsers.SQL_FILE_PATH);
