...
public class MergeTwo {
     ...
     * Examples:
     * <ul>
     *   <li>mergeTwo(["a", "c", "z"], ["b", "f", "z"], 3) -> ["a", "b",
     *   "c"]</li>
     *   <li>mergeTwo(["a", "c", "z"], ["c", "f", "z"], 3) -> ["a", "c",
     *   "f"]</li>
     *   <li>mergeTwo(["f", "g", "z"], ["c", "f", "g"], 3) -> ["c", "f",
     *   "g"]</li>
     * </ul>
     * </p>
     *
     ...
     * @return A sorted list of the first `n` unique strings from merging `a`
     * and `b`
     */
