...
public class CreateATable {
     ...
     * both columns should have the datatype varchar(100), which represents a
     ...
     * problem1.sql file.
     *
     * Do not change anything in this code. You should write your sql statement
     * on a single line in the
     *     problem1.sql file.
     */
