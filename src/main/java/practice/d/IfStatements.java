 ...
 * 
 * If you would like to read additional resources, we recommend:
 * https://www.w3schools.com/java/java_conditions.asp
 */
public class IfStatements {
    /**
     * This method should return the parameter `x` if the parameter `bool` is
     * true, otherwise return the parameter `y`.
     * 
    ...
    /**
     * This method should return "Positive" if the parameter `x` is a positive
     * number, "Negative" if the parameter `x` is a negative number, or "Zero"
     * if the parameter `x` is zero.
     *  
    ...
    /**
     * This method should return "Yes", "No", or depending on whether the
     * parameter `year` represents a leap year.
     * 
     * - Return "No" if `year` is NOT divisible by 4
     * - If `year` is divisible by 4, then:
     *      - Return "Not quite" if `year` is also divisible by 100 but NOT by
     *        400
     *      - Return "Yes" if `year` is also divisible by 100 AND by 400
     *      - Return "Yes" otherwise
     * 
     * To check if a value is divisible by another, use the modulo operator (%)
     * to check if the remainder is zero.
     * 
