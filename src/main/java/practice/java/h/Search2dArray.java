...
/**
 * Search 2d Array Challenge
 */
public class Search2dArray {
    /**
     * Receive a 2d array of ints. (That's an array of arrays!)
     * Your task is to search the array for a matching value, return true if
     * found false otherwise. You'll need to use a for loop within a for loop -
     * each for loop handles searching in a particular dimension.
     *
