...
public class Sets {
     ...
     *
     * Like List, Set is an interface. However, the Set interface is different:
     * for instance, it doesn't make sense for Sets to have a get method to
     * retrieve an item at a particular index from a set, because Sets are
     * unordered.
     *
     * Some common implementations of Set are HashSet and TreeSet.
    ...
    /**
     * Add a new, unique item to a set. Sets can only store unique items.
     * @param set The set that we will be manipulating.
