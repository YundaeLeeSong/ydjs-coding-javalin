...
public class Contains {
    ...
    /**
     * This method should search an array to see if that array contains some
     * value. You will need to use a for loop to check every value of the array
     * to see if it matches the target value.
     *
