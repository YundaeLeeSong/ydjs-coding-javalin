...
/**
 * Boolean Operators Challenge
 * 
 * In order to make our programs even more impressive and interactive, we need
 * to learn how to better leverage boolean expressions. This will allow our
 * programs to follow their own logic. For this example, you should look into
