...
/**
 * Insert Position Challenge
 */
public class InsertPosition {

    /**
     * Find the position that a number should be inserted into in a sorted array.
     * For instance, in the array {2,4,6,8,10}, inserting 5 would belong at
     * position 2, since the resulting array would be {2,4,5,6,8,10}, where the
     * index of 5 is 2 (remember zero-indexing.)
